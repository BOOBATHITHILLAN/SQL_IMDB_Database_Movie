...
insert into review(movie_id,user_name,rating) values(1,'Boobathi',5);
insert into review(movie_id,user_name,rating) values(2,'Boobathi',5);
insert into review(movie_id,user_name,rating) values(1,'udaya',5);
